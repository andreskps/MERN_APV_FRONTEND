...
import clienteAxios from "../config/axios" //tiene ya axios y una url base
...
const Registrar = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = '/veterinarios/' //API DE REGISTRO DE USUARIOS
    ...
    const {msg} = alerta  //valida si hay un mensaje antes de mostrarlo,si no hay mensaje no lo muestra
